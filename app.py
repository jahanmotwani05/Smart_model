...
def load_model_cache():
    # Load the model and specify the custom loss function explicitly
    return load_model('plant_disease_model.h5', custom_objects={'SparseCategoricalCrossentropy': tf.keras.losses.SparseCategoricalCrossentropy()})
...
class_names = ['Pepper__bell___Bacterial_spot', 'Pepper__bell___healthy', 'Potato___Early_blight',
               'Potato___Late_blight', 'Potato___healthy', 'Tomato_Early_blight',
